    ...
    const handleFileUpload = async () => {
        ...
        try {
            ...
            const uploadResult = await new Promise((resolve) => {
                setTimeout(() => resolve({ success: true, imageUrl: URL.createObjectURL(newProject.imageFile) }), 1000);
            });
    ...
    return (
        <>
            <section className="mt-10">
                <h2 className="flex items-center text-3xl font-semibold cursor-pointer">Projects
                    {auth?
                    <svg 
                    ...
                    stroke-linejoin="round">  <path stroke="none" d="M0 0h24v24H0z" />  <circle cx="12" cy="12" r="9" />  <line x1="9" y1="12" x2="15" y2="12" />  <line x1="12" y1="9" x2="12" y2="15" /></svg>:<></>}
                </h2>
